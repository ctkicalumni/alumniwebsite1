...
@Component({
  selector: 'app-app-purchase-membership',
  templateUrl: './app-purchase-membership.component.html',
  styleUrls: ['./app-purchase-membership.component.scss']
})
export class AppPurchaseMembershipComponent implements OnInit {
  memberships: any;
